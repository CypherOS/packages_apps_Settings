...
public class DozePreferenceController extends PreferenceController implements
	...
	@Override
    public void onStart() {
        mContext.getContentResolver().registerContentObserver(mObserver);
    }
	...
	private void isDozeActivated() {
        Settings.Secure.getInt(mContext.getContentResolver(), DOZE_ENABLED, 1);
    }
