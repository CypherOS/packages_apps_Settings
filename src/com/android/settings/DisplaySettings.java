...
public class DisplaySettings extends SettingsPreferenceFragment implements
        ...
        if (mController.isAvailable(activity)) {
			...
			mNightDisplayPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                public boolean onPreferenceClick(Preference preference) {
                    ...
                    intent.setClassName("com.android.settings.display",
                            "com.android.settings.display.NightDisplaySettings");
                    mNightDisplayPreference.setIntent(intent);
                    return false;
                }
            });
	...
	public void onActivated(boolean activated) {
        mNightDisplayPreference.setChecked(activated);
    }
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<String> getNonIndexableKeys(Context context) {
                    ...
                    if (!mController.isAvailable(context)) {
