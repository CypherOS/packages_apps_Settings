...
public class LongPressAccessPointInfoPreference extends AccessPointPreference {

    private final Fragment mFragment;

    public LongPressAccessPointInfoPreference(AccessPoint accessPoint, Context context,
