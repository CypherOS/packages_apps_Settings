...
public class WifiSettings extends RestrictedSettingsFragment
        ...
        if (view != null) {
            view.post(new Runnable() {
                ...
                public void run() {
					...
					Object tagMeter = accessPoint.getTag();
                    if (tag != null) {
                        ((LongPressAccessPointPreference) tag).refresh();
                    }
					if (tagMeter != null) {
						((LongPressConnectedAPSignalPreference) tagMeter).refreshMeter();
					}
					setConnectedApHeader(mConnectedAP);
                }
            });
    ...
    public void onLevelChanged(AccessPoint accessPoint) {
		((LongPressConnectedAPSignalPreference) accessPoint.getTag()).onLevelChanged();
