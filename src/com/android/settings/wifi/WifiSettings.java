...
public class WifiSettings extends RestrictedSettingsFragment
    ...
    private boolean configureConnectedAccessPointPreferenceCategory(
        ...
        ((LongPressAccessPointPreference) mConnectedAPPreferenceCategory.getPreference(0))
                .refresh();
        return true;
    }
	...
	private void setConnectedApHeader(AccessPoint connectedAp) {
        ...
        Drawable wifiIcon = getWifiIcon(iconSignalLevel).mutate();
	...
	private void setDisabledApHeader() {
		...
		mEntityHeaderController.setSummary("Not connected");
		Drawable wifiIconDisabled = getContext().getResources().getDrawable(R.drawable.ic_wifi_disabled);
	...
	@NonNull 
	public Drawable getWifiIcon(@IntRange(from=0, to=4) int signalLevel) {
		final Resources res = getContext().getResources();
        switch (signalLevel) {
            case 0:
                return res.getDrawable(R.drawable.ic_settings_wifi_signal_0);
            case 1:
                return res.getDrawable(R.drawable.ic_settings_wifi_signal_1);
            case 2:
                return res.getDrawable(R.drawable.ic_settings_wifi_signal_2);
            case 3:
                return res.getDrawable(R.drawable.ic_settings_wifi_signal_3);
            case 4:
                return res.getDrawable(R.drawable.ic_settings_wifi_signal_4);
            default:
