...
public class MyDeviceInfoFragment extends DashboardFragment
    ...
    private void initHeader() {
        ...
        if (mMultiUserVersion == UserManager.MULTI_USER_V1) {
			...
			mHeaderPreference.isCustom(true).setCustomLayout(R.layout.settings_entity_header);
			...
			mHeaderPreference.isCustom(true).setCustomLayout(R.layout.header_about_phone);
            EntityHeaderController controller = EntityHeaderController
                    .newInstance(context, this, appSnippet)
                    .setRecyclerView(getListView(), getLifecycle())
