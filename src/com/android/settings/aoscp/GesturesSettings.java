...
public class GesturesSettings extends SettingsPreferenceFragment implements
	...
	private static final String KEY_MOVES_GESTURES = "moves_gestures";
	...
	private PreferenceCategory mMovesGestures;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (isCameraDoubleTapPowerGestureAvailable(getResources())) {
            ...
            mMovesGestures.removePreference(findPreference(KEY_DOUBLE_TAP_POWER));
        }
        ...
        if (mAmbientConfig.pulseOnPickupAvailable()) {
            ...
            mMovesGestures.removePreference(findPreference(KEY_PICK_UP));
        }
        if (mAmbientConfig.pulseOnDoubleTapAvailable()) {
            ...
            mMovesGestures.removePreference(findPreference(KEY_DOUBLE_TAP_SCREEN));
        }
        ...
        if (isSystemUINavigationAvailable(context)) {
            ...
            mMovesGestures.removePreference(findPreference(KEY_SWIPE_DOWN_FINGERPRINT));
        }
        ...
        if (isDoubleTwistAvailable(context)) {
            ...
            mMovesGestures.removePreference(findPreference(KEY_DOUBLE_TWIST));
        }
