...
package com.android.settings.aoscp.support.actions;
...
/**
 * {@link DialogFragment} for bug reporting.
 */
public final class SupportBugReportFragment extends DialogFragment implements
        DialogInterface.OnClickListener {

    public static final String TAG = "SupportBugReport";
    ...
    public static SupportBugReportFragment newInstance(
	        @SupportManagerCallback.SupportType int type) {
		final SupportBugReportFragment fragment = new SupportBugReportFragment();
        return fragment;
    }
	
	@Override
    public Dialog onCreateDialog(Bundle savedInstanceState, DialogInterface.OnClickListener listener) {
		super.onCreateDialog(builder, listener);
		
        final AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        final View content = LayoutInflater.from(builder.getContext())
                .inflate(R.layout.bugreport_options_dialog, null);
        mInteractiveTitle = (CheckedTextView) content.findViewById(R.id.bugreport_option_interactive_title);
        mInteractiveSummary = (TextView) content.findViewById(R.id.bugreport_option_interactive_summary);
        mFullTitle = (CheckedTextView) content.findViewById(R.id.bugreport_option_full_title);
        mFullSummary = (TextView) content.findViewById(R.id.bugreport_option_full_summary);
