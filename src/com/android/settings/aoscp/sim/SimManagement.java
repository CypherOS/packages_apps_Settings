...
public class SimManagement extends RestrictedSettingsFragment implements Indexable {
	...
	private TextView mSlot1Status;
	private TextView mSlot2Status;
	...
	private void updateSimHeader() {
		...
		mSlot1Status = (TextView) mSimHeader.findViewById(R.id.slot_1_status);
		mSlot2Status = (TextView) mSimHeader.findViewById(R.id.slot_2_status);
	...
	public void updateSlot1ProvisionStatus() {
		...
		if (mUiccProvisionStatus[0] == PROVISIONED) {
			mSlot1Status.setText("Active");
		} else {
			mSlot1Status.setText("Inactive");
		}
    }
	...
	public void updateSlot2ProvisionStatus() {
		...
		if (mUiccProvisionStatus[1] == PROVISIONED) {
			mSlot2Status.setText("Active");
		} else {
			mSlot2Status.setText("Inactive");
		}
    }
	...
	private void updateSlot1() {
		...
		if (sir != null) {
			...
			mSimCard.setAlpha(255);
		    mSlot1Carrier.setText(sir.getCarrierName());
			mSlot1.setClickable(true);
			mSlot1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
					final SettingsActivity sa = (SettingsActivity)getActivity();
					sa.startFragWithInstance(new SimManagementTool(mContext, 0), true, 
			...
			mSlot1.setImageDrawable(mSimCard);
			mSimCard.setAlpha(128);
            mSlot1Carrier.setText(R.string.sim_slot_empty);
			mSlot1.setClickable(false);
        }
	}
	...
	private void updateSlot2() {
		...
		if (sir != null) {
			...
			mSlot2.setClickable(true);
			mSlot2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
					final SettingsActivity sa = (SettingsActivity)getActivity();
					sa.startFragWithInstance(new SimManagementTool(mContext, 1), true,
					        String.format(mContext.getResources().getString(
		                    R.string.sim_management_tool_title), sir.getCarrierName()));
                }
            });
