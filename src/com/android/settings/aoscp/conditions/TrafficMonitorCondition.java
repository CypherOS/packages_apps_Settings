...
package com.android.settings.aoscp.conditions;
...
public final class TrafficMonitorCondition extends Condition {
	...
	public boolean isTrafficMonitorEnabled() {
        return Settings.System.getInt(mManager.getContext().getContentResolver(), Settings.System.NETWORK_TRAFFIC_STATE, 1) != 0;
    }
