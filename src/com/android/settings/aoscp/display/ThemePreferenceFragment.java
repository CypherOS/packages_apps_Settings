...
public class ThemePreferenceFragment extends RadioButtonPickerFragment {
	...
	static final String THEME_DEFAULT = "co.aoscp.theme.default";
	static final String THEME_TEAL = "co.aoscp.theme.teal";
    ...
    protected String getDefaultKey() {
		String theme = KEY_THEME_DEFAULT;
		if (THEME_DEFAULT) {
            theme = KEY_THEME_DEFAULT;
        }
		if (THEME_TEAL) {
            theme = KEY_THEME_TEAL;
        }
		return theme;
    }
    ...
    protected boolean setDefaultKey(String key) {
        switch (key) {
            case KEY_THEME_DEFAULT:
                try {
                    mOverlayService.setEnabled(THEME_DEFAULT,
