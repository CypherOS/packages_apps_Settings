...
import com.android.settings.aoscp.ambient.AmbientPlayHistoryPreference;
...
public class AmbientPlaySettings extends DashboardFragment implements Indexable {
	...
	private AmbientPlayHistoryPreference mHistoryPreference;
	...
	private BroadcastReceiver mSongMatched = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(AmbientPlayHistoryManager.INTENT_SONG_MATCH.getAction())) {
                if (mHistoryPreference != null){
                    mHistoryPreference.updateSummary(getActivity());
                }
            }
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		mHistoryPreference = (AmbientPlayHistoryPreference) findPreference(KEY_AMBIENT_HISTORY);
    }
    ...
    public void onResume() {
        super.onResume();
        initHeader();
		getActivity().registerReceiver(mSongMatched, new IntentFilter(AmbientPlayHistoryManager.INTENT_SONG_MATCH.getAction()));
        if (mHistoryPreference != null){
            mHistoryPreference.updateSummary(getActivity());
        }
    }
