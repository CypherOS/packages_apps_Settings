            ...
            for (int colorMode : availableModes) {
                if (colorMode == 0) {
                    candidates.add(new DisplayModeCandidateInfo(
                                ctx.getText(Integer.valueOf(mHwManager.getDisplayModeName(0))),
                                KEY_DISPLAY_MODE_DEFAULT, true /* enabled */));
                } else if (colorMode == 1) {
                    candidates.add(new DisplayModeCandidateInfo(
                                ctx.getText(Integer.valueOf(mHwManager.getDisplayModeName(1))),
                                KEY_DISPLAY_MODE_1, true /* enabled */));
                } else if (colorMode == 2) {
                    candidates.add(new DisplayModeCandidateInfo(
                                ctx.getText(Integer.valueOf(mHwManager.getDisplayModeName(2))),
                                KEY_DISPLAY_MODE_2, true /* enabled */));
                } else if (colorMode == 3) {
                    candidates.add(new DisplayModeCandidateInfo(
                                ctx.getText(Integer.valueOf(mHwManager.getDisplayModeName(3))),
    ...
    protected boolean setDefaultKey(String key) {
        switch (key) {
            case KEY_DISPLAY_MODE_DEFAULT:
                mHwManager.setDisplayMode(0, false);
                break;
            case KEY_DISPLAY_MODE_1:
                mHwManager.setDisplayMode(1, false);
                break;
            case KEY_DISPLAY_MODE_2:
                mHwManager.setDisplayMode(2, false);
                break;
            case KEY_DISPLAY_MODE_3:
                mHwManager.setDisplayMode(3, false);
                break;
        }
        return true;
    }
