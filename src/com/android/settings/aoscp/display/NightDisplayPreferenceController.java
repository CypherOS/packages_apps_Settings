...
public class NightDisplayPreferenceController extends NightDisplayIllustrationPreferenceController {
    ...
    protected boolean isSwitchPrefEnabled() {
        final int nightDisplayEnabled = Settings.Secure.getInt(
                  mContext.getContentResolver(), NIGHT_DISPLAY_ACTIVATED, OFF);
