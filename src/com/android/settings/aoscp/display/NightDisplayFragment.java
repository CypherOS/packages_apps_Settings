...
public class NightDisplayFragment extends DashboardFragment implements NightDisplayController.Callback, 
	...
	public static final int NIGHT_DISPLAY_MID = 2840;
	public static final int NIGHT_DISPLAY_LOW = 4082;
	public static final int NIGHT_DISPLAY_DEFAULT = 2850;
    ...
    public void displayResourceTiles() {
        ...
        switch (mController.getColorTemperature()) {
            ...
            case NIGHT_DISPLAY_LOW:
                ...
                break;
			case convertTemperature(mController.getColorTemperature()):
    ...
    public void onRadioButtonClicked(RadioButtonPreference pref) {
        switch (pref.getKey()) {
			...
			case KEY_NIGHT_DISPLAY_CUSTOM:
			    convertTemperature(mController.getColorTemperature())
