...
public class BatteryLightSettings extends SettingsPreferenceFragment implements
	...
	private SettingPref mEnabledPref;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEnabledPref = new SettingPref(SettingPref.TYPE_SYSTEM, 
		                    System.BATTERY_LIGHT_ENABLED, mBatteryLightEnabled ? 1 : 0) != 0);
        mEnabledPref.init(this);
	...
	private void tryEnableBatteryLight(boolean mode) {
        if (!isBatteryLightEnabled(mode)) {
	...
	private void updateSwitch() {
        final boolean mode = isBatteryLightEnabled();
	...
	public boolean isBatteryLightEnabled() {
        return mContext.getContentResolver(), Settings.System.BATTERY_LIGHT_ENABLED, 1;
    }
