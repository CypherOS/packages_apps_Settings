...
public class BatteryLightSettings extends SettingsPreferenceFragment implements
	...
	private void tryEnableBatteryLight(boolean enabled) {
        if (!isBatteryLightEnabled(enabled)) {
	...
	public boolean isBatteryLightEnabled(boolean enabled) {
		return Settings.System.getInt(mContext.getContentResolver(), BATTERY_LIGHT_ENABLED, 1);
    }
