...
public class ButtonSettings extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mButtonBrightnessSupport = res.getBoolean(com.android.internal.R.bool.config_deviceHasVariableButtonBrightness);
        ...
        if (deviceKeys == 0) {
            ...
            mDisableHwKeys.setChecked(harwareKeysDisable);
        }
    }
    ...
    private void updateDisableHWKeyEnablement(boolean harwareKeysDisable) {
        ...
        mHomeCategory.setEnabled(!harwareKeysDisable);
        mMenuCategory.setEnabled(!harwareKeysDisable);
        mAppSwitchCategory.setEnabled(!harwareKeysDisable);
        mAssistCategory.setEnabled(!harwareKeysDisable);
    }
}