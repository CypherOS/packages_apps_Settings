...
public class ConnectedAPSignalPreference extends Preference {
    ...
    @VisibleForTesting
    static void setTitle(ConnectedAPSignalPreference preference, AccessPoint ap, boolean savedNetworks) {
		int summarySignalLevel = ap.getLevel();
        preference.setTitle(String.format(mContext.getResources().getString(
