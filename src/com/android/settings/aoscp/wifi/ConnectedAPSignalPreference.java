...
public class ConnectedAPSignalPreference extends Preference {
    ...
    protected void updateIcon(int level, Context context) {
        Drawable drawable = getContext().getResources().getDrawable(getMeter(level).mutate());
        if (drawable != null) {
	...
	private int getMeter(int signalLevel) {
        switch (signalLevel) {
            case 0:
                return R.color.ic_settings_wifi_meter_poor_fair; // Poor 0
            case 1:
                return R.color.ic_settings_wifi_meter_poor_fair; // Poor 1
            case 2:
                return R.color.ic_settings_wifi_meter_poor_fair; // Fair 2
            case 3:
                return R.color.ic_settings_wifi_meter_poor_fair; // Good 3 // Change me to ic_settings_wifi_meter_good_excellent
            case 4:
                return R.color.ic_settings_wifi_meter_good_excellent; // Excellent 4
            default:
	...
	private int getMeterColor(int signalLevel) {
        switch (signalLevel) {
            ...
            case 3:
                return R.color.ic_signal_meter_fair; // Good 3 // Change me to ic_signal_meter_good
            case 4:
                return R.color.ic_signal_meter_excellent; // Excellent 4
            default:
                throw new IllegalArgumentException("Invalid signal level: " + signalLevel);
        }
    }
