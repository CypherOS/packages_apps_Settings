...
public class FooterConfirmMixinViewCreator {

    private Context mContext;
    private FooterConfirmMixinView mConfirmView;
    private WindowManager mWindowManager;

    public FooterConfirmMixinViewCreator(Context context) {
        mContext = context;
    ...
    public FooterConfirmMixinView getConfirmMixinView() {
        createConfirmView();
        return mConfirmView;
    }
