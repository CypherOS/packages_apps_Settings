...
public class AoscpVersionPreferenceController extends AbstractPreferenceController
    ...
    public AoscpVersionPreferenceController(Context context, Lifecycle lifecycle) {
        super(context);
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        if (pref != null) {
            pref.setSummary(mContext.getResources().getString(R.string.aoscp_build_information_summary));
        }
    }
