...
public final class ColorManagerFragment extends InstrumentedFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
		...
		updateThemePreview(mSelectedTheme, mIsDark);
	...
	public static void updateThemePreview(int selectedTheme, boolean isDark) {
		...
		//mCollapsingToolbar.setBackgroundColor(ContextCompat.getColor(mContext, selectedTheme));
		//mCollapsingToolbar.setStatusBarScrimColor(ContextCompat.getColor(mContext, selectedTheme));
		//mCollapsingToolbar.setContentScrimColor(ContextCompat.getColor(mContext, selectedTheme));
	}
