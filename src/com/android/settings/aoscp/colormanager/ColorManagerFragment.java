...
public final class ColorManagerFragment extends InstrumentedFragment {
	...
	private static ImageView mThemePreview;
	...
	public static void updateThemePreview(int selectedTheme) {
		...
		mThemePreview = (ImageView) mContent.findViewById(R.id.theme_preview);
		
		Drawable drawable = VectorDrawable.create(getActivity().getResources(), R.drawable.ic_theme_preview, null);
		drawable = Drawable.wrap(drawable);
		Drawable.setTint(drawable, selectedTheme);
		
		mThemePreview.setImageDrawable(drawable);
	}
