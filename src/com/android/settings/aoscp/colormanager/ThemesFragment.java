...
public class ThemesFragment extends DashboardFragment
    ...
    public void displayResourceTiles() {
        ...
        switch (Settings.Secure.getInt(getContentResolver(), Settings.Secure.DEVICE_THEME, 0)) {
            case 0:
			    ColorManagerFragment.updateThemePreview(R.color.theme_preview_default, false);
            ...
            case 1:
                ...
                break;
            case 2:
			    ColorManagerFragment.updateThemePreview(R.color.theme_preview_dark, true);
                updateThemeItems(KEY_THEME_DARK);
                break;
            case 3:
			    ColorManagerFragment.updateThemePreview(R.color.theme_preview_black, true);
