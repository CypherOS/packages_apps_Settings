...
public class AmbientPlayNotificationPreferenceController extends AbstractPreferenceController implements
        PreferenceControllerMixin, Preference.OnPreferenceChangeListener {

    private String mKey;

    public AmbientPlayNotificationPreferenceController(Context context, String key) {
        super(context);
        mKey = key;
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        Settings.System.putInt(mContext.getContentResolver(), AMBIENT_RECOGNITION_NOTIFICATION,
                enabled ? 1 : 0);
        return true;
    }
}
