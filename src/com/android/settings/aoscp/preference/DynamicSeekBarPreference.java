...
public class DynamicSeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    public DynamicSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr,
            int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.DynamicSeekBarPreference);
        ...
        Integer id = a.getResourceId(R.styleable.DynamicSeekBarPreference_units, 0);
        if (id > 0) {
        ...
        setLayoutResource(R.layout.preference_dynamic_seekbar);
    }
    ...
    public DynamicSeekBarPreference(Context context, AttributeSet attrs) {
