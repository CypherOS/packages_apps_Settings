...
public class ScreenshotModePreferenceController extends PreferenceController implements
    ...
    public void updateState(Preference preference) {
		...
		updateScreenshotModeSummary(mScreenshotType, mScreenshotTypeValue);
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        try {
            ...
            Settings.System.putInt(mContext.getContentResolver(), SCREENSHOT_TYPE, mScreenshotTypeValue);
			updateScreenshotModeSummary((ListWithEntrySummaryPreference) preference, mScreenshotTypeValue);
	...
	private void updateScreenshotModeSummary(Preference mScreenshotType, String mScreenshotTypeValue) {
        if (mScreenshotTypeValue != null) {
            ...
            for (int i = 0; i < values.length; i++) {
                if (mScreenshotTypeValue.equals(values[i])) {
        ...
        Log.e(TAG, "Invalid screenshot mode value: " + mScreenshotTypeValue);
    }
}
