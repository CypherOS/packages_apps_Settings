...
public class NetworkTrafficPreferenceController extends AbstractPreferenceController implements
    ...
    private final String mTrafficMonitorKey;
	
	private final TrafficMonitorStateReceiver mTrafficMonitorStateReceiver;
    private MasterSwitchPreference mTrafficMonitorPref;

    public NetworkTrafficPreferenceController(Context context, String key) {
        super(context);
        mTrafficMonitorKey = key;
    ...
    public String getPreferenceKey() {
        return mTrafficMonitorKey;
    }
	
	@Override
    public void displayPreference(PreferenceScreen screen) {
        super.displayPreference(screen);
        mTrafficMonitorPref = (MasterSwitchPreference) screen.findPreference(mTrafficMonitorKey);
    }
	...
	public boolean isTrafficMonitorEnabled() {
        return Settings.System.getInt(mContext.getContentResolver(), NETWORK_TRAFFIC_STATE, 1);
    }
