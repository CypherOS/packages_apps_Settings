...
public class TapToSleepPreferenceController extends AbstractPreferenceController implements
    ...
    public void updateState(Preference preference) {
        int value = Settings.System.getInt(mContext.getContentResolver(), GESTURE_DOUBLE_TAP_SLEEP, 1);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        Settings.System.putInt(mContext.getContentResolver(), GESTURE_DOUBLE_TAP_SLEEP, value ? 1 : 0);
        return true;
    }
