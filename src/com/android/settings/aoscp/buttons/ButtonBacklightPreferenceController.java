...
public class ButtonBacklightPreferenceController extends AbstractPreferenceController implements
    ...
    public ButtonBacklightPreferenceController(Context context, String key) {
        super(context);
    ...
    public boolean isAvailable() {
        ...
        mButtonBacklightSupported = res.getBoolean(
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        mButtonBacklightPref = (MasterSwitchPreference) screen.findPreference(mButtonBacklightKey);
    }

    @Override
    public void updateState(Preference preference) {
        // int navBarEnabled = Settings.System.getInt(mContext.getContentResolver(), NAVIGATION_BAR_ENABLED, 1);
        // mButtonBacklightPref.setEnabled(navBarEnabled != 0);
