...
import static android.provider.Settings.System.BUTTON_BRIGHTNESS;
...
public class ButtonBacklightPreferenceController extends AbstractPreferenceController implements
	...
	public boolean isButtonBacklightEnabled() {
        return Settings.System.getInt(mContext.getContentResolver(), BUTTON_BRIGHTNESS, isAvailable() ? 1 : 0) != 0;
    }

    public boolean setButtonBacklightEnabled(boolean enabled) {
        return Settings.System.putInt(mContext.getContentResolver(), BUTTON_BRIGHTNESS, enabled ? 1 : 0);
    }
