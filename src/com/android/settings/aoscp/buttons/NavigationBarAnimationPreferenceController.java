...
public class NavigationBarAnimationPreferenceController extends AbstractPreferenceController implements
    ...
    public boolean isAvailable() {
		...
		boolean available = res.getBoolean(R.bool.config_allowOpaLayout);
    ...
    public void updateState(Preference preference) {
        ...
        int value = Settings.System.getInt(mContext.getContentResolver(), NAVIGATION_BAR_ANIMATION, 
		           navigationBarEnabled ? 1 : 0, UserHandle.USER_CURRENT) != 0;
