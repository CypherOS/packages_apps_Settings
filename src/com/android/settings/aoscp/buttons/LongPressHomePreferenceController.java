...
public class LongPressHomePreferenceController extends PreferenceController implements
    ...
    public void updateState(Preference preference) {
        ...
        if (mLongPressHome != null) {
			...
			mLongPressHome.setSummary(mLongPressHome.getEntry());
        }
    }
