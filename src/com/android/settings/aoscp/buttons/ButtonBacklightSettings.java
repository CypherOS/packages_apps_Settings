...
public class ButtonBacklightSettings extends SettingsPreferenceFragment implements
	...
	public boolean isButtonBacklightEnabled() {
        return Settings.System.getInt(mContext.getContentResolver(), Settings.System.BUTTON_BRIGHTNESS_ENABLED, mButtonBacklightEnabled ? 1 : 0) != 0;
    }
  
    public boolean setButtonBacklightEnabled(boolean enabled) {
        return Settings.System.putInt(mContext.getContentResolver(), Settings.System.BUTTON_BRIGHTNESS_ENABLED, enabled ? 1 : 0);
    }
