...
import com.android.settings.aoscp.network.NetworkIndicationPreferenceController;
...
public class NetworkDashboardFragment extends DashboardFragment implements
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(Context context,
		...
		final NetworkIndicationPreferenceController networkIndicationPreferenceController =
                new NetworkIndicationPreferenceController(context);
		...
		controllers.add(networkIndicationPreferenceController);
        return controllers;
    }
