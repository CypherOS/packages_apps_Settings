        ...
        switch (item.getItemId()) {
			...
			case SUBMENU_BATTERY_PORTRAIT:
                ...
                Settings.Secure.putInt(getActivity().getContentResolver(),
                    Settings.Secure.STATUSBAR_BATTERY_STYLE, 0);
                return true;
			case SUBMENU_BATTERY_LANDSCAPE:
                item.setChecked(true);
                Settings.Secure.putInt(getActivity().getContentResolver(),
                    Settings.Secure.STATUSBAR_BATTERY_STYLE, 5);
                return true;
		    case SUBMENU_BATTERY_CIRCLE:
                item.setChecked(true);
                Settings.Secure.putInt(getActivity().getContentResolver(),
                    Settings.Secure.STATUSBAR_BATTERY_STYLE, 2);
                return true;
			case SUBMENU_BATTERY_TEXT:
                item.setChecked(true);
                Settings.Secure.putInt(getActivity().getContentResolver(),
                    Settings.Secure.STATUSBAR_BATTERY_STYLE, 6);
                return true;
			case SUBMENU_BATTERY_HIDDEN:
                item.setChecked(true);
                Settings.Secure.putInt(getActivity().getContentResolver(),
                    Settings.Secure.STATUSBAR_BATTERY_STYLE, 4);
                return true;
            default:
