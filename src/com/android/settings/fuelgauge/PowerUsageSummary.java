...
public class PowerUsageSummary extends PowerUsageBase {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
		...
		SubMenu batteryPercentMenu = menu.addSubMenu(1, MENU_BATTERY_PERCENT, 1, R.string.status_bar_battery_percentage_title);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case SUBMENU_BATTERY_PERCENT_NEXT:
                item.setChecked(true);
                Settings.Secure.putInt(getActivity().getContentResolver(),
                    Settings.Secure.STATUS_BAR_SHOW_BATTERY_PERCENT, 2);
                return true;
            default:
