...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (preference.getKey().equals(KEY_FIRMWARE_VERSION)
                || preference.getKey().equals(KEY_AOSCP_VERSION)) {
		...
		intent.putExtra("aoscp", preference.getKey().equals(KEY_AOSCP_VERSION));
            ...
            if (mDevHitCountdown > 0) {
                ...
                if (mDevHitCountdown == 0) {
                    ...
                    mDevHitInfo = SnackShackDialogHelper.prompt(
							...
							getResources().getString(R.string.R.string.show_dev_on_aoscp),
                            getResources().getString(R.string.R.string.show_dev_on_aoscp_msg),
